<div class="grid-container">
        ...
        <div class="active square large" data-poster-path="{{asset('img/applewatch.jpg')}}">
            <div class="flag flag-top-right square">
                ...
                <p class="flag-content">
                    Content written here about this particular doster, maybe the heart of the blurb/PSA.
                </p>
            </div>

            <div class="share-fill-container">
                <div id="test" class="share-fill share-fill-twitter"></div>
    ...
    <div class="square large-holder">
        <div class="square small spacer q1"></div>
